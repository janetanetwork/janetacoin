...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " janetacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  janetacoin-tx [options] <hex-tx> [commands]  Update hex-encoded janetacoin transaction\n" +
            "or:     janetacoin-tx [options] -create [commands]   Create hex-encoded janetacoin transaction\n" +
            "\n";
