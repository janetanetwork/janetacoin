...
{
    const char* pszTimestamp = "YAHOO NEWS 4/SEP/2022 4-Plane safely lands after pilot threatened to crash into Mississippi Walmart";
...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("seed-a.janetacoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.janetacointools.com");
        //vSeeds.emplace_back("dnsseed.janetacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("59d4ff50fd4dddb429ebdd5c6c6584fba592d5f1d9c761f5afc0972d8244c091"));
        assert(genesis.hashMerkleRoot == uint256S("007280f346412812a0c5f50a094998a41d8256aa31b63ef764d6e252f8f93532"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.janetacointools.com");
        //vSeeds.emplace_back("seed-b.janetacoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1662285222, 0, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0658e5e24f2ea66c313bf23bb30cd0f8604a9a9a51ff48597728b1277d93a9e8"));
        assert(genesis.hashMerkleRoot == uint256S("007280f346412812a0c5f50a094998a41d8256aa31b63ef764d6e252f8f93532"));
        ...
        checkpointData = {
            {
                {0, uint256S("0658e5e24f2ea66c313bf23bb30cd0f8604a9a9a51ff48597728b1277d93a9e8")},
            }
        };
