Contributing to Janetacoin Core
============================

The Janetacoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Janetacoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/janetacoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to janetacoin-qt
...
The following applies to code changes to the Janetacoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Janetacoin
Network Protocol consensus changes.

Whether a pull request is merged into Janetacoin Core rests with the project merge
...
Patches that change Janetacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Janetacoin consensus, it must have been
...
The project leader is the release manager for each Janetacoin Core release.
