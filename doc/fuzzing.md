# Fuzzing Janetacoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Janetacoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/janetanetwork/janetacoin
$ cd janetacoin/
$ ./autogen.sh
...
[`process_message`](https://github.com/janetanetwork/janetacoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/janetanetwork/janetacoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/janetanetwork/janetacoin/tree/master/src/test/fuzz).
...
Every single pull request submitted against the Janetacoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Janetacoin Core more robust.
...
with certain assembly code from Janetacoin Core's code. See [developer notes on sanitizers](https://github.com/janetanetwork/janetacoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Janetacoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Janetacoin Core using [`afl-fuzz`](https://github.com/google/afl):
