...
"""Verify that starting janetacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start janetacoin with -h for help text")
        ...
        self.log.info("Start janetacoin with -version for version information")
        ...
        self.log.info("Start janetacoind with -fakearg to make sure it does not start")
